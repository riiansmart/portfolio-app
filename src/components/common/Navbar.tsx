    ...
    <nav className="backdrop-blur-md bg-black/60 border-b border-white/10 shadow-lg sticky top-0 z-50 w-full">
      <div className="container mx-auto flex items-center justify-between py-2 px-4">
        ...
        <ul className="hidden md:flex space-x-2 md:space-x-6">
          <li><a href="#about" className="px-4 py-2 rounded-full text-sm font-semibold tracking-wide text-white hover:bg-gradient-to-r hover:from-indigo-500 hover:to-pink-500 hover:text-white hover:shadow-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-indigo-400" tabIndex={0} aria-label="Navigate to About section">About</a></li>
          <li><a href="#projects" className="px-4 py-2 rounded-full text-sm font-semibold tracking-wide text-white hover:bg-gradient-to-r hover:from-indigo-500 hover:to-pink-500 hover:text-white hover:shadow-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-indigo-400" tabIndex={0} aria-label="Navigate to Projects section">Projects</a></li>
          <li><a href="#skills" className="px-4 py-2 rounded-full text-sm font-semibold tracking-wide text-white hover:bg-gradient-to-r hover:from-indigo-500 hover:to-pink-500 hover:text-white hover:shadow-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-indigo-400" tabIndex={0} aria-label="Navigate to Skills section">Skills</a></li>
        </ul>
        {/* Right: Resume Button & Mobile Nav */}
        <div className="flex items-center gap-2">
          <Button asChild variant="secondary" className="hidden md:inline-block bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white font-semibold shadow-lg hover:scale-105 hover:shadow-2xl transition-transform duration-200 border-none">
            <a href="/resume.pdf" target="_blank" rel="noopener noreferrer" tabIndex={0} aria-label="Download Resume">Resume</a>
          </Button>
          {/* Mobile Nav */}
          <Sheet>
            ...
            <SheetContent side="left" className="bg-black/90 border-r border-white/10">
              <nav className="flex flex-col gap-6 mt-10">
                ...
                <Button asChild variant="secondary" className="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white font-semibold shadow-lg mt-4 border-none">
                  <a href="/resume.pdf" target="_blank" rel="noopener noreferrer" tabIndex={0}>Resume</a>
                </Button>
              </nav>
            </SheetContent>
          </Sheet>
